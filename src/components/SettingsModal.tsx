        ...
        <div className="flex items-center justify-between pb-4 border-b border-white/[0.08]">
          <div className="flex items-center gap-2.5">
            <div className="w-9 h-9 rounded-xl bg-purple-500/15 border border-purple-500/30 flex items-center justify-center">
              <Key className="w-4 h-4 text-[#9B5DE5]" />
            </div>
            <div>
              <h2 className="text-lg font-bold text-white tracking-tight font-heading">Интеграции и настройки API</h2>
              <p className="text-xs text-[#9A9AB0]">Настройка Gemini, n8n и хранилища S3/R2</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSave} className="mt-6 space-y-5">
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              <label className="text-xs font-semibold text-slate-300 flex items-center gap-1.5">
                <Sparkles className="w-3.5 h-3.5 text-[#F15BB5]" /> Gemini API Key:
              </label>
            ...
            <input
              ...
              className={`w-full px-4 py-2.5 rounded-xl bg-[#0A0A12] border text-white font-mono text-xs focus:outline-none transition ${
                isCustomKeyActive ? 'border-purple-500/50' : 'border-white/[0.08]'
              }`}
            />
          ...
          <div>
            <label className="block text-xs font-semibold text-slate-300 mb-1.5 flex items-center gap-1.5">
              <Server className="w-3.5 h-3.5 text-[#9B5DE5]" /> URL вебхука n8n:
            </label>
            <input
              type="url"
              ...
              className="w-full px-4 py-2.5 rounded-xl bg-[#0A0A12] border border-white/[0.08] text-white font-mono text-xs focus:outline-none focus:border-purple-500 transition-colors"
            />
